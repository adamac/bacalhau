...
func SetDefaults(cfg BacalhauConfig) {
	...
	viper.SetDefault(NodeServerAPIReadHeaderTimeout, cfg.Node.ServerAPI.ReadHeaderTimeout.String())
	viper.SetDefault(NodeServerAPIReadTimeout, cfg.Node.ServerAPI.ReadTimeout.String())
	viper.SetDefault(NodeServerAPIWriteTimeout, cfg.Node.ServerAPI.WriteTimeout.String())
	viper.SetDefault(NodeServerAPIRequestHandlerTimeout, cfg.Node.ServerAPI.RequestHandlerTimeout.String())
	viper.SetDefault(NodeServerAPISkippedTimeoutPaths, cfg.Node.ServerAPI.SkippedTimeoutPaths)
	viper.SetDefault(NodeServerAPIMaxBytesToReadInBody, cfg.Node.ServerAPI.MaxBytesToReadInBody)
	viper.SetDefault(NodeServerAPIThrottleLimit, cfg.Node.ServerAPI.ThrottleLimit)
	viper.SetDefault(NodeServerAPIProtocol, cfg.Node.ServerAPI.Protocol)
	viper.SetDefault(NodeServerAPILogLevel, cfg.Node.ServerAPI.LogLevel)
	viper.SetDefault(NodeServerAPIEnableSwaggerUI, cfg.Node.ServerAPI.EnableSwaggerUI)
	...
	viper.SetDefault(NodeComputeExecutors, cfg.Node.Compute.Executors)
	viper.SetDefault(NodeComputeExecutorsPlugins, cfg.Node.Compute.Executors.Plugins)
	viper.SetDefault(NodeComputeStorages, cfg.Node.Compute.Storages)
	viper.SetDefault(NodeComputeStoragesPlugins, cfg.Node.Compute.Storages.Plugins)
	viper.SetDefault(NodeComputePublishers, cfg.Node.Compute.Publishers)
	viper.SetDefault(NodeComputePublishersPlugins, cfg.Node.Compute.Publishers.Plugins)
...
func Set(cfg BacalhauConfig) {
	...
	viper.Set(NodeServerAPIReadHeaderTimeout, cfg.Node.ServerAPI.ReadHeaderTimeout.String())
	viper.Set(NodeServerAPIReadTimeout, cfg.Node.ServerAPI.ReadTimeout.String())
	viper.Set(NodeServerAPIWriteTimeout, cfg.Node.ServerAPI.WriteTimeout.String())
	viper.Set(NodeServerAPIRequestHandlerTimeout, cfg.Node.ServerAPI.RequestHandlerTimeout.String())
	viper.Set(NodeServerAPISkippedTimeoutPaths, cfg.Node.ServerAPI.SkippedTimeoutPaths)
	viper.Set(NodeServerAPIMaxBytesToReadInBody, cfg.Node.ServerAPI.MaxBytesToReadInBody)
	viper.Set(NodeServerAPIThrottleLimit, cfg.Node.ServerAPI.ThrottleLimit)
	viper.Set(NodeServerAPIProtocol, cfg.Node.ServerAPI.Protocol)
	viper.Set(NodeServerAPILogLevel, cfg.Node.ServerAPI.LogLevel)
	viper.Set(NodeServerAPIEnableSwaggerUI, cfg.Node.ServerAPI.EnableSwaggerUI)
	...
	viper.Set(NodeComputeExecutors, cfg.Node.Compute.Executors)
	viper.Set(NodeComputeExecutorsPlugins, cfg.Node.Compute.Executors.Plugins)
	viper.Set(NodeComputeStorages, cfg.Node.Compute.Storages)
	viper.Set(NodeComputeStoragesPlugins, cfg.Node.Compute.Storages.Plugins)
	viper.Set(NodeComputePublishers, cfg.Node.Compute.Publishers)
	viper.Set(NodeComputePublishersPlugins, cfg.Node.Compute.Publishers.Plugins)
